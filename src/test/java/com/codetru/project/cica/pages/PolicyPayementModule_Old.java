...
public class PolicyPayementModule_Old extends CommonPageCICA {
	...
	public void Make_a_Payment() throws Exception {
		...
		WebUI.clickElement(customerTab);
		WebUI.sleep(2);
		...
		for ( String policyNumber : policies) {
			...
			try{
				...
				firstpolicy_number=policyNumber;
				break;
			}
		}
		...
		try {
			...
			System.out.println(firstpolicy_number+" is currently on recurring payment");
		}catch (Exception e) {
			System.out.println(firstpolicy_number+" is not on recurring payment");
		}
		...
		System.out.println(amountUsValue);
		...
		for ( String policyNumber : policies) {
			...
			try{
				...
				System.out.println(policyNumber+" Is a valid Polid Policy Number");
				secondPolicyNumber=policyNumber;
				break;
			}
		}
		WebUI.clickElement(relationDropdown);
