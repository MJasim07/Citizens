...
public class Step_1PageMain extends CommonPageCICA{
	...
	private By selectPlan_Alleg = By.xpath("//option[.=' Allegiant Superior Choice Standard Issue']");
	private By selectPlan_Alleg_G = By.xpath("//option[.=' Allegiant Superior Choice Guarantee Issue']");
...
//	==============================Global Person Popup Fields Validation ============================================================================	
		...
		WebUI.verifyContains(getTextElement(personInfo_ssn_max_err_msg), personInfo_SsnMax_error);
		...
		WebUI.verifyContains(getTextElement(personInfo_address1_err_msg), Max_Error);
		...
		//============ Proposed insured info person popup validation ====================================================
		WebUI.sleep(2);
...
//		C.Empty_Input(driver, ErrorMessage_BasePlan, Mandate_Error, e, Test.Case1(31),Test.Exp1(31)); 
		WebUI.verifyContains(getTextElement(ErrorMessage_BasePlan), Mandate_Error);
		
//------------------------------------------------------------------------------------------------------------------
//-------------------------------------- Get the Plan from Logo-----------------------------------------------------
		WebUI.sleep(1);
		
		File screenshot = WebUI.getWebElement(logoElement).getScreenshotAs(OutputType.FILE);
		String textResult = "";
		     // Save the element screenshot to disk
		     File screenshotLocation = new File("C:\\Users\\Codetru\\Downloads\\CitizensFull 5\\Codetru_CitizensAgent\\ExportData\\Images\\test.png");
		     try {
		        ...
		        System.out.println(screenshotLocation.getAbsolutePath());
		         ...
		         e.printStackTrace();
				  ...
				  ITesseract instance = new Tesseract();  // JNA Interface Mapping
			        instance.setDatapath("C:\\Users\\Codetru\\Downloads\\CitizensFull 5\\Codetru_CitizensAgent\\src\\test\\resources\\tessdata");
			        try {
			        	textResult = instance.doOCR(screenshotLocation);
...
//------------------------------------------------------------------------------------------------------------------
		...
		WebUI.scrollToElementAtBottom(Annually);
		WebUI.sleep(0.5);
		WebUI.verifyElementNotVisible(Accidental_Checkbox);
...
//		C.C2(driver, plan, selectPlan, e, Test.Case1(30),Test.Exp1(30));
		...
		//Select plan as per the agencies 
		if(textResult.contains("CICA"))
		{
			WebUI.verifyElementVisible(selectPlan_CICA);
			WebUI.verifyElementVisible(selectPlan_Garuntee);
			WebUI.setText(plan, "c", Keys.ENTER);
			WebUI.sleep(0.5);
			WebUI.verifyElementVisible(selectPlan_CICA);
			WebUI.clickElement(plan);
			WebUI.sleep(1);
		...
		{
			WebUI.scrollToElementAtBottom(calculate);
			WebUI.verifyElementVisible(selectPlan_Alleg);
			WebUI.verifyElementVisible(selectPlan_Alleg_G);
			WebUI.setText(plan, "a", Keys.ENTER);
			WebUI.sleep(1);
			WebUI.verifyElementVisible(selectPlan_Alleg);
			WebUI.clickElement(plan);
			WebUI.sleep(1);
			WebUI.clickElement(selectPlan_Alleg);
			WebUI.sleep(0.5);
		}
...
//		C.Send_verify_Valid_C(driver, FaceAmount, e, "30000", Test.Case1(38),Test.Exp1(38));//
		WebUI.clearAndFillText(FaceAmount, "30000");
		WebUI.sleep(0.2);
		WebUI.verifyContains(getAttributeElement(FaceAmount,"value"), "30000");
		
//		C.scrollTo(driver, calculate, e, Test.Case1(35),Test.Exp1(35));//
		WebUI.scrollToElementAtBottom(calculate);
		WebUI.sleep(0.2);
		WebUI.clickElement(calculate);
		
//		C.scrollTo(driver, DateOfBirth);
		WebUI.scrollToElementAtTop(DateOfBirth);  //errorMessageAge- Element ....... age_Max_Error - String
		WebUI.sleep(0.2);
		
//		C.Error_Verify(driver, Error_Message_Age, "The maximum amount is 85.", e, Test.Case1(60),Test.Exp1(60));//
		WebUI.verifyContains(getTextElement(errorMessageAge).trim(), age_Max_Error);
		
//		C.MX_SC(driver, act, DateOfBirth, calculate,DateOfBirth, ErrorMessage_FaceAmount, "01011940", "The maximum amount is 10000.", e, Test.Case1(61),Test.Exp1(61));//
...
//		C.MX_SC2(driver, act, DateOfBirth, calculate, ErrorMessage_FaceAmount, "01011970", "The maximum amount is 20000.", e, Test.Case1(62),Test.Exp1(62));//
		WebUI.scrollToElementAtTop(DateOfBirth);
		WebUI.sleep(0.2);
...
//		C.S_Send_S(driver, act, DateOfBirth, calculate, "01011991", e, Test.Case1(63),Test.Exp1(63));//
		WebUI.scrollToElementAtTop(DateOfBirth);
		WebUI.sleep(0.2);
		WebUI.clearAndFillText(DateOfBirth, "01011991");
		WebUI.sleep(0.2);
		ageTextBoxValue = getAttributeElement(age,"value");
		WebUI.scrollToElementAtBottom(calculate);
		WebUI.sleep(0.2);
		WebUI.clickElement(calculate);
		
//		C.scrollTo(driver, FaceAmount);
...
//		WebUI.setText(FaceAmount, "3001");
		...
		//Verify Accidental_Checkbox enabled and able to check and unchecked 
		WebUI.sleep(0.5);
		WebUI.verifyElementVisible(Accidental_Checkbox);
		WebUI.clickElement(Accidental_Checkbox);
		WebUI.sleep(2);
//		WebUI.verifyElementChecked(Accidental_Checkbox);
		WebUI.verifyElementEnabled(Accidental_Checkbox);
		WebUI.clickElement(Accidental_Checkbox);
		WebUI.sleep(0.5);
		
//		C.Clk_Is_Enabled(driver, Annually, e,  Test.Case1(42),Test.Exp1(42));
		WebUI.verifyElementEnabled(Annually);
		WebUI.clickElement(Annually);
		
		
//		C.Clk_Is_Enabled(driver, Semi_Annually, e,  Test.Case1(43),Test.Exp1(43));
		WebUI.verifyElementEnabled(Semi_Annually);
		WebUI.clickElement(Semi_Annually);
		
//		C.Clk_Is_Enabled(driver, Quarterly, e,  Test.Case1(44),Test.Exp1(44));
		WebUI.verifyElementEnabled(Quarterly);
		WebUI.clickElement(Quarterly);
		
//		C.Clk_Is_Enabled(driver, Monthly, e,  Test.Case1(45),Test.Exp1(45));
		WebUI.verifyElementEnabled(Monthly);
		WebUI.clickElement(Monthly);
		
		WebUI.sleep(1);
//		WebUI.verifyElementCheckedUsingJS(Monthly);
		WebUI.verifyElementNotChecked(Quarterly);
		WebUI.verifyElementNotChecked(Semi_Annually);
		WebUI.verifyElementNotChecked(Annually);		
		
//		C.Clk_Is_Enabled(driver, Yes, e, Test.Case1(46),Test.Exp1(46));
		WebUI.verifyElementEnabled(Yes);
		WebUI.clickElement(Yes);
//		C.Clk_Is_Enabled(driver, No, e,  Test.Case1(47),Test.Exp1(47));
		WebUI.verifyElementEnabled(No);
		...
		WebUI.verifyElementVisible(basePremium);
		WebUI.verifyElementNotVisible(accidentalDeathPremium);
		
		WebUI.clickElement(Accidental_Checkbox);
		WebUI.sleep(0.2);
		WebUI.clickElement(calculate);
		WebUI.verifyElementVisible(accidentalDeathPremium);
		...
		WebUI.sleep(2);
		List<String> stepsList = WebUI.getElementTextsInList(steps_List);
		for(int i=0; i<stepsList.size(); i++)
		{
			WebUI.verifyContains(stepsList.get(i),"Step "+(i+1) );
		}
		...
		WebUI.scrollToElementAtBottom(calculate);
		WebUI.moveToElement(backToList);
		WebUI.clickElement(backToList);
		WebUI.sleep(1);
		WebUI.verifyElementVisible(list_ColumnNames);
